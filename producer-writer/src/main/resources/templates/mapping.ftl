    ...
    public ResponseEntity<${method.returnTypeName}> ${method.methodName}<#compress>(<#list method.parameterList as param>${(param_index==0)?then('',',\n ')}${param.annotation} ${param.type} ${param.name}</#list></#compress>){
